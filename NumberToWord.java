...
/**
 * 
 * @author rameshpaladugu
 * Converts a given number to it's equivalent word
 *
 */
public class NumberToWord {
    ...
    private static String[] teen =  {" Ten",
								    " Eleven",
								    " Twelve",
								    " Thirteen",
								    " Fourteen",
   ...
   private static String[] tens = { " Twenty",
								    " Thirty",
								    " Forty",
								    " Fifty",
								    " Sixty",
  ...
  private static Scanner in;
	...
	/*
	 * Accepts the input and displays the resulted word
	 */
	 private static void inputNumber()
	 {
        ...
        try
        {
          ...
          System.out.println("input in Words : " + result);
        }
        catch(Exception e)
        {
	 ...
	 /*
	  * Takes number as input and returns it's equivalent word
	  */
